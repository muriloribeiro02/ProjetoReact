                ...
                <tbody>
                    {students.map(item => (
                        <tr key={item.id} className="text-gray-800 bg-gray-400 border-gray-600">
                            ...
                            <td className="p-3">
                                {item.active && <div className="px-2 py-1 inline-block border-green-800 bg-green-600 text-white text-xs">Active</div>}
                                {!item.active && <div className="px-2 py-1 inline-block border-red-800 bg-red-600 text-white text-xs">Inactive</div>}    
                            </td> 
